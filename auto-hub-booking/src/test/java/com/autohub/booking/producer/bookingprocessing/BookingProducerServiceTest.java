...
class BookingProducerServiceTest {
    ...
    void sendSavedBookingTest_errorOnSendingMessage() {
        ...
        AutoHubException autoHubException =
                assertThrows(AutoHubException.class, () -> bookingProducerService.sendSavedBooking(bookingResponse));
    ...
    void sendUpdatedBookingTest_errorOnSendingMessage() {
        ...
        AutoHubException autoHubException =
                assertThrows(AutoHubException.class, () -> bookingProducerService.sendUpdatedBooking(bookingResponse));
    ...
    void sendDeletedBookingTest_errorOnSendingMessage() {
        ...
        AutoHubException autoHubException =
                assertThrows(AutoHubException.class, () -> bookingProducerService.sendDeletedBooking(1L));
