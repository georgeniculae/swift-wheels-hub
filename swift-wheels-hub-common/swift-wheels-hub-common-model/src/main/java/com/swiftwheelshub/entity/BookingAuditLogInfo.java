...
@Getter
@Setter
public class BookingAuditLogInfo extends BaseEntity {
    ...
    public BookingAuditLogInfo(String methodName, String username, LocalDateTime timestamp, List<String> parametersValues) {
